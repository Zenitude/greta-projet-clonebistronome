...
{
    const carte = document.createElement('div') as HTMLDivElement;
    ...
    const imgMenu = document.createElement('img') as HTMLImageElement;
    ...
    const intitule = document.createElement('p') as HTMLParagraphElement;
